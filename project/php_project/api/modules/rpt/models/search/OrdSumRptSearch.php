 ...
 */
class OrdSumRptSearch extends OrdInfo
{
    public $csarea_name;     //营销区域
    public $sts_sname;       //销售点
    ...
    {
        return [
            [['csarea_name', 'ord_no', 'ord_status',  'sts_sname',  'cust_shortname', 'cust_code', 'staff_name', 'start_date', 'end_date',
               ], 'safe'],
   ...
   /*         ->leftJoin('pdt.bs_partno n', 'n.prt_pkid=a.prt_pkid')
        ...
        $query->andFilterWhere([
            ...
            'l.sts_sname'=> $this->sts_sname //销售点
        ]);
