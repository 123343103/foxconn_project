...
use app\modules\system\models\search\ReceiptSearch;
use yii;
 ...
 */
class ReceiptController extends BaseActiveController
{
    public $modelClass = 'app\modules\common\models\BsReceipt';
    ...
    {
        $model = new ReceiptSearch();
        $dataProvider = $model->search(Yii::$app->request->queryParams);
        $model = $dataProvider->getModels();
        $list['rows'] = $model;
        $list['total'] = $dataProvider->totalCount;
        return $list;
//        $data = BsReceipt::getAll();
//        return $data;
    ...
    {
        if (($model = BsReceipt::findOne($id)) !== null) {
            return $model;
        } else {
