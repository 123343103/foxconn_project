...
use app\modules\system\models\search\CurrencySearch;
use yii;
 ...
 */
class CurrencyController extends BaseActiveController
{
    public $modelClass = 'app\modules\common\models\BsCurrency';
...
//        return $data;
    ...
    {
        if (($model = BsCurrency::findOne($id)) !== null) {
            return $model;
        } else {
