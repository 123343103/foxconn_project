...
use app\modules\system\models\search\TradConditionSearch;
use yii;
 ...
 */
class TradConditionController extends BaseActiveController
{
    public $modelClass = 'app\modules\common\models\BsTradCondition';
    ...
    {
        if (($model = BsTradConditions::findOne($id)) !== null) {
            return $model;
        } else {
