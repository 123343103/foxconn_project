...
/**
 * This is the model class for table "l_ord_info".
 *
...
class LOrdInfo extends Common
{
    ...
    public function rules()
    {
        return [
            [['ord_id'], 'required'],
            [['ord_id', 'os_id', 'price_id', 'origin_hid', 'ord_type', 'corporate', 'trade_mode', 'invoice_type', 'distinct_id', 'invoice_Title_AreaID', 'receipt_areaid', 'cur_id', 'pac_id', 'pay_type', 'Is_org', 'audit_id', 'nwer', 'opper', 'caner', 'yn'], 'integer'],
    ...
    {
        return $this->hasMany(LOrdDt::className(), ['l_ord_id' => 'l_ord_id']);
    }
    ...
    {
        return $this->hasMany(LOrdFile::className(), ['l_ord_id' => 'l_ord_id']);
    }
    ...
    {
        return $this->hasMany(LOrdPay::className(), ['l_ord_id' => 'l_ord_id']);
    }
