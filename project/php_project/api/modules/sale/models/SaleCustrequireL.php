...
/**
 * This is the model class for table "sale_custrequire_l".
 *
 ...
 */
class SaleCustrequireL extends Common
{
    ...
    {
        return [
            [['sapl_id', 'saph_id', 'pdt_id', 'whs_id', 'origin_hid', 'distribution', 'transport', 'comp_pdtid'], 'integer'],
