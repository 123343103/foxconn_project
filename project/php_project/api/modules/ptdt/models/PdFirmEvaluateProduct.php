...
/**
 * This is the model class for table "pd_firm_evaluate_product".
 *
 ...
 */
class PdFirmEvaluateProduct extends Common
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'pd_firm_evaluate_product';
    }
    ...
    {
        return [
            [['evaluate_id', 'evaluate_child_id', 'report_id', 'report_child_id', 'report_product_id', 'product_no', 'product_status'], 'integer'],
