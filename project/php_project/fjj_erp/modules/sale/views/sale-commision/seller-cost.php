...
$this->params['breadcrumbs'][] = ['label' => '销售汇总表（导入固定费用）', 'url' => Url::to([''])];
?>
<div class="content">
    ...
    <?= Html::button('导入固定费用', ['class' => 'button-blue-big ml-50', 'id' => 'showDiv', 'href'=>'#inline']) ?>
    <?= Html::button('上一步', ['class' => 'button-blue-big ml-50', 'id' => 'showDiv2', 'onclick'=>'window.location.href="'.Url::to(['detail-to-sum']).'"']) ?>
    <?= Html::button('下一步', ['class' => 'button-blue-big ml-50', 'onclick'=>'window.location.href="'.Url::to(['store-cost']).'"']) ?>
</div>
