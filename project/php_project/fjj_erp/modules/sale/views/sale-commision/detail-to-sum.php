...
$this->params['breadcrumbs'][] = ['label' => '销售汇总表（导入人力成本）', 'url' => Url::to([''])];
...
<div class="content">
    ...
    <?= Html::button('导入人力薪资', ['class' => 'button-blue-big ml-50', 'id' => 'showDiv', 'href'=>'#inline']) ?>
    <?= Html::button('上一步', ['class' => 'button-blue-big ml-50', 'id' => 'showDiv2', 'onclick'=>'window.location.href="'.Url::to(['index']).'"']) ?>
    <?= Html::button('下一步', ['class' => 'button-blue-big ml-50', 'onclick'=>'window.location.href="'.Url::to(['seller-cost']).'"']) ?>
</div>
    ...
    $(function () {
        ...
        $("#data").datagrid({
            ...
            columns: [[
                ...
                {field: "sale_date1", title: "业务费用", width: 80},

                {field: "default", title: "间接人力薪资", width: 50},
                {field: "default", title: "直接人力薪资", width: 100},

                {field: "default", title: "固定费用", width: 50},
