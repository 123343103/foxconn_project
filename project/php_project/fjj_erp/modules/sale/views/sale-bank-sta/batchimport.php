...
<div class="content">
    ...
    <div>
        ...
        <div id="table1" style="margin-top: 15px;"></div>
        <div style="text-align: center;display: none;margin-top: 15px;" id="button">
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.status == 0) {
                    ...
                    $.ajax({
                        url: "<?=\yii\helpers\Url::to(['save-list'])?>?importList=" + importList,
                        dataType: "json",
                        type: "get",
                        success: function (data) {
                            if (data.status == 0) {
