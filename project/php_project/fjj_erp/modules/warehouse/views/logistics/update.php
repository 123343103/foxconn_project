...
<h1 class="head-first">修改物流进度</h1>

<?php $form = ActiveForm::begin([
    'id' => 'update',
    //'method'=>'get',
    //'enableAjaxValidation' => true,
    'action' => ['/warehouse/logistics/update?id='.$model['ship_iid']]
    //'action'=>Url::to(['add'])
]) ?>
<!--<div style="margin-left: 100px">-->
<div class="mb-10"  style="float: left;margin-top: 50px;margin-left: 30px;">
    <div class="inline-block  required">
        ...
        <input type="text" maxlength="50" name="OrdLogisticLog[orderno]" class="width-200 easyui-validatebox "
               data-options="required:'true'" id="orderno" readonly="true" value="<?= $model['orderno'] ?>">
    </div>
    <div class="inline-block  required">
    ...
    <div class="inline-block  required">
        <p class="gang-shu">
            ...
            <input type="radio" name="OrdLogisticLog[TRANS_MODE]"  data-options="required:'true'"
                   id="transmode"   value="<?= $model['TRANS_MODE'] ?>">陆运
            <input type="radio" name="OrdLogisticLog[TRANS_MODE]"  data-options="required:'true'"
                   id="transmodes" value="<?= $model['TRANS_MODE'] ?>">快递
...
<!--                   class="width-200 easyui-validatebox select-date-time" data-options="required:'true'" id="onwaystatus_date"-->
