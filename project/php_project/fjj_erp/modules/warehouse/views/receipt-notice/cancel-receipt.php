...
<div style="margin:0 15px 10px;">
    ...
    <textarea style="width:400px;height:150px;" class="easyui-validatebox" data-options="required:true,validType:'maxLength[200]',tipPosition:'top'" placeholder="最多输入200个字" name="RcpNotice[cancel_reason]"></textarea>
</div>
