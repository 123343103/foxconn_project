...
?>
<div class="mb-10">
    <label style="width:100px;">收货通知单号：</label>
    <input id="val1" type="text" style="width:200px;">
    <label style="width:60px;">单据状态：</label>
    <select id="val2" style="width:200px;">
...
<div class="mb-10">
    <label style="width:100px;">单据类型：</label>
    <select id="val3" style="width:200px;">
        <option value="">全部</option>
        <option value="1">采购</option>
        <option value="2">调拨</option>
        <option value="3">移仓</option>
    </select>
    <label style="width:60px;">关联单号：</label>
    <input id="val4" type="text" style="width:200px;">
    <label style="width:60px;">通知日期：</label>
