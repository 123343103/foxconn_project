...
<div >
    ...
    <div class="content"  style="margin-top: 5px;margin-left: 15px;padding-top: 5px;">
        ...
        <textarea id="reason" name="BsPck[cancle_reason]" data-options="required:'true'" class="easyui-validatebox" data-options="validType:'length[0,100]'" style="width:320px;height:150px;outline: none;" maxlength="100"></textarea>
