...
<div class="mb-10">
    ...
    <span style="width:200px;"><?=$data['arr1']['inout_flag_val']?></span>
</div>
<div class="mb-10">
            ...
            storeNumValidate:{
                validator:function(value){
                    ...
                    if(reg.test($.trim(value)+",")){
                        ...
                        var total=$(this).parents("tr").find("td:eq(5)").text();
                        total=parseFloat(total);
                        if(result==total){
                            return true;
                        }else{
                            $.fn.validatebox.defaults.rules.storeNumValidate.message="存放数量总和应等于入仓数量";
                        }
                    }else{
