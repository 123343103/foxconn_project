...
$this->params['breadcrumbs'][] = ['label' => '新增车辆信息', 'url' => ""];
?>
...
<div class="content">
    ...
    <div>
        <div class="mb-20">
            ...
            <input id="veh_number" class="width-200 easyui-validatebox" data-options="required:true,validType:'unique',delay:500" ] data-attr="veh_number" value="" name="BsVeh[veh_number]" />
            <label class="width-150"><span class="red">*</span>车辆类型</label>
            <input id="veh_type" type="text" value="" class="width-200 easyui-validatebox" data-options="required:true" data-attr="veh_type"  name="BsVeh[veh_type]" />
        </div>
        <div class="mb-20">
            ...
            <select id="bsveh-veh_company" class="width-200 easyui-validatebox" name="BsVeh[log_code]">
                ...
                <?php foreach ($companyname as $key => $val) { ?>
                    <option value="<?= $val['log_code'] ?>"><?= $val['log_cmp_name'] ?></option>
                <?php } ?>
            </select>
            <label class="width-150"><span class="red">*</span>车辆品牌</label>
            <input id="veh_brand" type="text" value="" class="width-200 easyui-validatebox" data-options="required:true" data-attr="veh_brand"  name="BsVeh[veh_brand]" />
        </div>
        <div class="mb-20">
            <label class="width-150 ml-50"><span class="red">*</span>负责人</label>
            <input id="person_charge" class="width-200 easyui-validatebox" data-options="required:true" data-attr="person_charge" value="" name="BsVeh[person_charge]" />
            <label class="width-150"><span class="red">*</span>电话</label>
            <input id="person_phone" type="text"  class="width-200 easyui-validatebox" data-options="required:true" data-attr="person_phone" name="BsVeh[person_phone]" value="" />
        </div>
        <div class="mb-20">
            <label class="width-150 ml-50"><span class="red">*</span>联系人</label>
            <input id="veh_contacts" class="width-200 easyui-validatebox" data-options="required:true" type="text" value="" name="BsVeh[veh_contacts]">
            <label class="width-150"><span class="red">*</span>电话</label>
            <input id="contacts_phone" class="width-200 easyui-validatebox" data-options="required:true" type="text" value="" name="BsVeh[contacts_phone]">
        </div>
        <div class="mb-20">
            <label class="width-150 ml-50"><span class="red">*</span>车辆颜色</label>
            <input id="veh_color" class="width-200 easyui-validatebox" data-options="required:true" type="text" value="" name="BsVeh[veh_color]">
        </div>
    </div>
