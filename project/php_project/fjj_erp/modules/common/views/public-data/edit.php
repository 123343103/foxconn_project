...
<h1 class="head-first">修改公共参数名称</h1>
<div class="ml-10">
    <div class="mb-10">
        <label class="label-width label-align">参数名称</label>
    ...
    <div class="mb-10">
        ...
        <input type="text" class="width-200 easyui-validatebox" data-options="required:true,validType:'length[0,30]'" name="BsPubdata[bsp_svalue]" value="<?=$data['bsp_svalue']?>">
    </div>
</div>
