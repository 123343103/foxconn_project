...
<div class="content">
    ...
    <div style="float: left;margin-bottom: 20px">
        <textarea maxlength="200" class="easyui-validatebox" data-options="required:true" id="reason" rows="10" style="width: 500px" placeholder="最多输入200字" name="BsPrch[can_rsn]"></textarea>
    </div>
