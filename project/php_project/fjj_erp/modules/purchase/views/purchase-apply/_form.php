...
<h2 class="head-second text-left">
    ...
    <div class="ml-10">
        <div class="mb-10">
            ...
            <label class="ml-220 label-width label-align"><span class="red">*</span>单据类型</label><label>:</label>
...
<input type="hidden" value="<?php date_default_timezone_set('prc');  echo date("y-m-d H:i:s",time());?>" name="BsReq[app_date]">
...
<!--    <label class="width-100">总金额</label><label>:</label>-->
<!--    <input type="hidden" name="BsReq[t_amount_addfax]" value="" class="_totalallprice">-->
<!--    <span class="_totalallprice" style="color: red"></span>-->
...
<!--                <th><p style="width:150px">退税率</p></th>-->
            ...
            <tbody id="product_table">
                    <tr>
                        ...
                        <td><input type='text' class='_partno easyui-validatebox' name='prod[0][BsReqDt][part_no]' data-options="required:'true',validateOnBlur:true,validType:'productCodeValidate'"></td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
<!--                        <td></td>-->
                        <td><input type='text'  name='prod[0][BsReqDt][req_nums]'  placeholder='请输入数量' class='_num easyui-validatebox ' maxlength="10" data-options="required:'true',validType:'intnum'"></td>
<!--                        <td><span class="_price"></span><input type='hidden' name='prod[0][BsReqDt][req_price]' class='subpri'></td>-->
<!--                        <td><span class='_spp'></span><input type='hidden' name='prod[0][BsReqDt][spp_id]' class='subspp'></td>-->
...
<!--                        <td><input type='hidden' name='prod[0][BsReqDt][rebat_rate]'></td>-->
                        <td><input type='text' name='prod[0][BsReqDt][remarks]' maxlength='100' class='_remarks' placeholder="最多输入100字" ></td>
...
//                                        $trLast.find("td:eq(7)").text(data.rows[i][j].invt_num);
//                                        $trLast.find("._num").val("");
//                                        $trLast.find("._price").text(data.rows[i][j].price);
//                                        $trLast.find(".subpri").val(data.rows[i][j].price);
//                                        $trLast.find("._spp").text(data.rows[i][j].spp_code);
//                                        $trLast.find(".subspp").val(data.rows[i][j].spp_id);
//                                        $trLast.find("td:eq(12)").text("");
...
//                                        $trLast.find("td:eq(14)").text("");
//                                        $trLast.find("td:eq(15)").text("");
//                                        $trLast.find("td:eq(16)").text("");
//                                        $trLast.find("td:eq(17)").text("");
//                                        $trLast.find("._remarks").val("");
//                                    }
                                }else {
...
//        var num=$(this).val();
//            var _price=$_num.parents("tr").find("td").eq(8).text();
...
//                        layer.alert("领用人不能为当前登录人",{icon: 2});
//                        $("._users").addClass("validatebox-invalid");
//                        return false;
                    }
                }else {
