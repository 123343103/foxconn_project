...
<div class="content">
    ...
    <div class="tab-content">
        <label style="font-size: 13px"><span style="color: red;">*</span>请输入取消原因:</label>
    </div>
    <div style="float: left;margin-bottom: 20px">
        <textarea maxlength="200"  class="easyui-validatebox" data-options="required:true,validType:'maxLength[200]'" id="reason" rows="10" style="width: 500px" placeholder="最多输入200字" name="BsReq[can_rsn]"></textarea>
    </div>
