...
?>
<div class="no-padding " style="width: 750px;">
        <h2 class="head-first" >选择导出列</h2>
<?php $form = ActiveForm::begin(['id'=>"select-columns"]) ?>
<div class="mb-10">
    <div class="display-flex"><p class="head ml-80 mb-10" style="margin-left: 80px;">所有列：</p> <p class="head ml-10 mb-10" style="margin-left: 280px;">导出列： </p></div>
    <select multiple="multiple" id="my-select" name="columns[]">
        ...
        <option value="cust_type-客户类型">客户类型</option>
        ...
        <option value="staff_email-邮箱">邮箱</option>
        <option value="custManager-客户经理人">客户经理人</option>
        <option value="district_name-所在地区">所在地区</option>
        ...
        <option value="cust_industrytype-行业类型">行业类型</option>
        ...
        <option value="bsp_svalue-会员类型">会员类型</option>
        <option value="YN-认证状态">认证状态</option>
        <option value="member_name-会员名">会员名</option>
        <option value="cust_email-邮箱" >注册邮箱</option>
        <option value="cust_tel2-注册手机">注册手机</option>
    </select>
    </div>
<div class="mb-20 text-center" style="margin-top: 20px;">
    <button class="button-blue-big" type="submit" >确定</button>
    <button class="button-white-big ml-10" type="button" onclick="parent.$.fancybox.close()">取消</button>
</div>
</div>
<?php ActiveForm::end() ?>
<script>
