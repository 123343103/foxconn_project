...
<div class="no-padding " style="width: 500px">
    ...
    <div class="mb-10">
        <label class="label-width qlabel-align " style="margin-left: 20px;width: 50px">区域<label>：</label></label>
    ...
    <div class="mb-10">
        ...
        <select  type="text" name="csarea_status" style="width: 150px" class="csarea_status">
...
<script>
    $(function () {
        $("#submit").on('click',function () {
            $.ajax({
                type: "POST",
                data: {id: "<?=$idarr?>",csarea_status:$(".csarea_status").val()},
                dataType: "json",
