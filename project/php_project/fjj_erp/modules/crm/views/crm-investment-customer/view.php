...
<div class="content">
    ...
    <div class="mb-10">
        <table width="90%" class="no-border vertical-center mb-10">
            ...
            <tr class="no-border mb-10">
                ...
                <td class="no-border vertical-center value-align" width="18%"><?= $model['member_compzipcode'] ?>
                    &nbsp;</td>
            </tr>
            <tr class="no-border mb-10">
            ...
            <tr class="no-border mb-10 <?= ($model['bsPubdata']['memberWeb'] == "") ? "hiden" : "" ?>">
                ...
                <td class="no-border vertical-center value-align" width="18%"><?= $model['member_name'] ?></td>
    ...
    <div class="mb-10" style="margin-left: 40px">
        <p class="mb-10 ml-20">客户其他联系人<label>：</label></p>
            ...
            layer.confirm("确定删除？", {
                ...
                $.get("<?=Url::to(['delete', 'id' => $model['cust_id']])?>", function (res) {
                    ...
                    if (obj.flag == 1) {
                        ...
                        window.location.href = "<?=Url::to(['list'])?>";
                    } else {
