        ...
        <div>
            ...
            <table class="credit-table mt-10">
                ...
                <tr>
                    ...
                    <td colspan="2"><p class="text-center width-150"><?= $model['total_investment_cur_name'] ?>&nbsp;<?= $model['total_investment'] ?></p></td>
                    <td colspan="2"><p class="text-center width-150"><?= $model['shareholding_ratio'] ?>%</p></td>
                    <td></td>
                </tr>
                <tr>
                ...
                <?php if(!empty($model['turnover'])){ ?>
                    <?php foreach ($model['turnover'] as $key => $val){ ?>
                        <tr>
                            <td><?= $key ?></td>
                            <td colspan="2"><?= $val[date('Y',time())-1] ?></td>
                            <td colspan="2"><?= $val[date('Y',time())-2] ?></td>
                            <td colspan="2"><?= $val[date('Y',time())-3] ?></td>
                        </tr>
                    <?php } ?>
                <?php }else{ ?>
                    <tr>
                ...
                <?php if(!empty($model['linkcomp'])){ ?>
                    <?php foreach ($model['linkcomp'] as $val){ ?>
                        <tr>
                            ...
                            <td colspan="2"><p class="text-center width-150"><?= $val['total_investment'] ?></p></td>
                            <td colspan="2"><p class="text-center width-150"><?= $val['shareholding_ratio'] ?></p></td>
                        </tr>
                    <?php } ?>
                <?php }else{ ?>
                    <tr>
                ...
                <?php if(!empty($model['custCustomer'])){ ?>
                    <?php foreach ($model['custCustomer'] as $val){ ?>
                        <tr>
                            ...
                            <td colspan="2"><p class="text-center width-150"><?= $val['cc_customer_ratio'] ?></p></td>
            ...
            <?php if($crmcertf['crtf_type']==0){ ?>
                <?php if(!empty($crmcertf['bs_license'])){ ?>
                    <div class="inline-block img-border">
                        <img class="img"src="<?=  Yii::$app->ftpPath['httpIP'] ?>/cmp/bslcns/<?= $newnName1 ?>/<?= $crmcertf['bs_license'] ?>" alt="">
                        <div class="img-title">
                ...
                <?php if(!empty($crmcertf['tx_reg'])){ ?>
                    <div class="inline-block img-border">
                        <img class="img" src="<?=  Yii::$app->ftpPath['httpIP'] ?>/cmp/txrg/<?= $newnName2 ?>/<?= $crmcertf['tx_reg'] ?>" alt="">
                        <div class="img-title">
                ...
                <?php if(!empty($crmcertf['qlf_certf'])){ ?>
                    <div class="inline-block img-border">
                        <img class="img" src="<?=  Yii::$app->ftpPath['httpIP'] ?>/cmp/txqlf/<?= $newnName3 ?>/<?= $crmcertf['qlf_certf'] ?>" alt="">
                        <div class="img-title">
            ...
            <div class="mb-10">
                ...
                <?php if(!empty($model['file1'])){ ?>
                    <?php foreach ($model['file1'] as $key7 => $val7) { ?>
                        <span class="value-align"><a href="<?=  Yii::$app->ftpPath['httpIP'] ?>/cca/credit/<?= $val7['date_file'] ?>/<?= $val7['file_new'] ?>"><?= $val7['file_old'] ?></a></span>
                    <?php } ?>
                <?php } ?>
            </div>
            <div class="mb-10">
                ...
                <?php if(!empty($model['file2'])){ ?>
                    <?php foreach ($model['file2'] as $key8 => $val8) { ?>
                        <span class="value-align"><a href="<?=  Yii::$app->ftpPath['httpIP'] ?>/cca/credit/<?= $val8['date_file'] ?>/<?= $val8['file_new'] ?>"><?= $val8['file_old'] ?></a></span>
                    <?php } ?>
                <?php } ?>
            </div>
        </div>
