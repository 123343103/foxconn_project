    ...
    <div class="mb-10 create_content">
        <table width="90%" class="no-border vertical-center mb-10">
            ...
            <tr class="no-border mb-10">
                ...
                <td class="no-border vertical-center label-align" width="7%">币别<label>：</label></td>
                <td class="no-border vertical-center" width="18%"><?= $info['cur_code'] ?></td>
            </tr>
            <tr class="no-border mb-10">
    ...
    $(function () {
        $('.data').datagrid({
            ...
            columns: [[
                ...
                {field: "default", title: "还款金额", width: 150},
                {field: "default", title: "还款方式", width: 150},
                {field: "yn_pay", title: "还款状态", width: 150},
                {field: "default", title: "还款时间", width: 150},
                {field: "default", title: "还款确认时间", width: 150},
