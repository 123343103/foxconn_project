...
<div class="content ml-15">
    ...
    <?php }else{ ?>
        ...
        <div class="mb-10">
            <label class="label-width label-align vertical-top"><span class="red">*</span>提醒内容</label><label class="vertical-top">:</label>
            <textarea style="width:535px;" name="CrmImessage[imesg_notes]" rows="3" class="easyui-validatebox value-align" data-options="required:'true',validType:'maxLength[200]'" maxlength="200" placeholder="最多输入200个字"></textarea>
        </div>
        <div class="text-center">
