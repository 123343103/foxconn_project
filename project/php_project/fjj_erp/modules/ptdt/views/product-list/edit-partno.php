...
$pdt_id=$data["pdt"]["pdt_pkid"];
$status=\Yii::$app->request->get("status");
$this->params['breadcrumbs'][] = ['label' => '查看料号信息（銷售中）','url'=>Url::to(['partno-list','id'=>$pdt_id,'status'=>$status])];
...
<?php $form = ActiveForm::begin(['id' => 'add-form']); ?>
    ...
    <div class="ml-10">
        <div class="mb-10">
            <label class="label-width label-align"><span class="red">*</span>品名：</label>
            <input name="BsProduct[pdt_name]" class="value-width value-align add-require easyui-validatebox"  data-options="required:true"    type="text" value="<?=$data["pdt"]['pdt_name']?>" maxlength="100">
            <label class="label-width label-align">品牌：</label>
            <?=Html::dropDownList("BsProduct[brand_id]",$data["pdt"]["brand_id"],$options["brands"],["prompt"=>"请选择","class"=>"value-width value-align"])?>
        </div>
        <div class="mb-10">
            <label class="label-width label-align" for="">商品标题：</label>
            <input class="value-width value-align"  type="text" name="BsProduct[pdt_title]" value="<?=$data['pdt']['pdt_title']?>" maxlength="200" >

            <label class="label-width label-align" for="">商品关键字：</label>
            <input class="value-width value-align"  type="text" name="BsProduct[pdt_keyword]" value="<?=$data['pdt']['pdt_keyword']?>" maxlength="200" >
            <span class="red">多个关键词用“，”字符间隔</span>
        </div>
        <div class="mb-20">
            <label class="label-width label-align">商品标签：</label>
            <input class="value-width value-align" type="text" name="BsProduct[pdt_label]" value="<?=$data['pdt']['pdt_label']?>" maxlength="100" >
            <label class="label-width label-align"><span class="red">*</span>商品属性：</label>
            <?=Html::dropDownList("BsProduct[pdt_attribute]",$data["pdt"]["pdt_attribute"],$options["pdt_attribute"],["prompt"=>"请选择","class"=>"value-width value-align easyui-validatebox","data-options"=>"required:true"])?>
        </div>
    </div>
    <div class="_basic">
        ...
        <div class="tab_css" id="tab1_content" style="display: block">
            <div class="mb-10">
                ...
                <input class="value-width value-align easyui-validatebox"  data-options="required:true" type="text" name="BsPartno[pdt_origin]" value="<?=$data['partno']['pdt_origin']?>"  maxlength="20" >
                <label class="label-width label-align" for="">型号：</label>
                <input class="value-width value-align"  type="text" name="BsPartno[tp_spec]" value="<?=$data['partno']['tp_spec']?>"  maxlength="100" >
                <label class="label-width label-align" for=""><span class="red">*</span>保质期（月）：</label>
                <input class="value-width value-align easyui-validatebox"  data-options="required:true,validType:'int'" type="text" name="BsPartno[warranty_period]" value="<?=$data['partno']['warranty_period']?>" maxlength="9"  >
            </div>
            <div class="mb-10">
                <label class="label-width label-align"  for=""><span class="red">*</span>销售包装数量：</label>
                <input class="value-width value-align easyui-validatebox"  data-options="required:true,validType:'decimal[8,2]'" type="text" id="pdt_qty" name="BsPack[1][pdt_qty]" value="<?=$data['pack'][1]['pdt_qty']?>" maxlength="9">
                <label class="label-width label-align" for=""><span class="red">*</span>最小起订量：</label>
                <input id="min_order" class="value-width value-align easyui-validatebox"  data-options="required:true,validType:['decimal[8,2]','minOrder']" type="text" name="BsPartno[min_order]" value="<?=$data['partno']['min_order']?>" maxlength="9"  >
            ...
            <div class="mb-10">
                <label class="label-width label-align" for="">商 品 定 位：</label>
                ...
                <span class="value-width value-align"><?=$data['partno']['l/t']?$data['partno']['l/t']:"/"?></span>
            ...
            <div class="mb-10">
                ...
                <span class="value-width value-align">
                    <?=Html::radio("BsPartno[yn_inquiry]",$data["partno"]["yn_inquiry"]==1,["value"=>1])?> 是&nbsp;&nbsp;<?=Html::radio("BsPartno[yn_inquiry]",$data["partno"]["yn_inquiry"]!=1,["value"=>0])?> 否
                </span>
                <label class="label-width label-align" for=""><span class="red">*</span>是 否 保 税：</label>
                <span class="value-width value-align">
                    <?=Html::radio("BsPartno[yn_tax]",$data["partno"]["yn_tax"]==1,["value"=>1])?> 是&nbsp;&nbsp;<?=Html::radio("BsPartno[yn_tax]",$data["partno"]["yn_tax"]!=1,["value"=>0])?> 否
                </span>
                <label class="label-width label-align" for=""><span class="red">*</span>是 否 自 提：</label>
                <span class="value-width value-align">
                    <?=Html::radio("BsPartno[isselftake]",$data["partno"]["isselftake"]==1,["value"=>'1'])?> 是&nbsp;&nbsp;<?=Html::radio("BsPartno[isselftake]",$data["partno"]["isselftake"]==0,["value"=>'0'])?> 否
                </span>
            </div>
            <div class="mb-10">
            ...
            <div class="mb-20">
                ...
                <textarea name="BsPartno[marks]" id="" style="width:795px;height:100px;" maxlength="200" placeholder="最多输入200个字"><?=$data["partno"]["marks"]?></textarea>
            </div>
            <div class="mb-20" id="_byself" style="display:<?=$data['partno']['isselftake']?"block":"none"?>">
                <label class="width-80" for="">自提仓库</label>
                <div class="_house">
                    <table class="table">
                        <thead>
                        <tr>
                            <th width="100"><input type="checkbox" id="house_all"></th>
                            <th width="150">仓库名</th>
            ...
            <table class="table">
                ...
                <?php if(count($data["price"])>0){ ?>
                    <?php foreach ($data["price"] as $k=>$price){ ?>
                        <tr>
                            <td width="200" class="minqty"><?=$k==0?$data["partno"]["min_order"]:$price["minqty"]?></td>
                            <td width="200" class="maxqty"><?=$price["maxqty"]?></td>
                            <td width="200"><?=$price["price"]==-1?'面议':$price["price"]?></td>
                            <td width="200"><?=$price["currency_name"]?></td>
                        </tr>
                    <?php } ?>
                <?php }else{ ?>
                    <tr>
        ...
        <div class="tab_css" id="tab7_content">
            <div class="mb-20">
                ...
                <?=Html::radio("BsPartno[yn_free_delivery]",$data["partno"]["yn_free_delivery"]==0,['value'=>0,'class'=>'city_all'])?>&nbsp;全国免运费&nbsp;
                <?=Html::radio("BsPartno[yn_free_delivery]",$data["partno"]["yn_free_delivery"]==1,['value'=>1,'class'=>'city_part'])?>&nbsp;全国部分城市免运费&nbsp;
                <?=Html::radio("BsPartno[yn_free_delivery]",$data["partno"]["yn_free_delivery"]==2,['value'=>2,'class'=>'city_all'])?>&nbsp;全国不免运费&nbsp;
                <?=Html::radio("BsPartno[yn_free_delivery]",$data["partno"]["yn_free_delivery"]==3,['value'=>3,'class'=>'city_part'])?>&nbsp;全国部分城市不免运费&nbsp;
            </div>
            <div class="mb-20">
                <?php
                if($data["partno"]["yn_free_delivery"]==0 || $data["partno"]["yn_free_delivery"]==2){
                    $display="none";
                }else{
                    $display="block";
                }
                ?>
                <div class="mb-10" id="_addadress" style="display:<?=$display?>">
                <table class="table" >
                    <thead>
                    <tr>
                        <th>序号</th>
                    ...
                    <?php if(count($data["deliv"])>0){ ?>
                        <?php foreach ($data["deliv"] as $k=>$deliv){ ?>
                            <tr>
                                <input type="hidden" name="BsDeliv[country_no][]" value="<?=$deliv["country_no"]?>" class="country_no" />
                                <input type="hidden" name="BsDeliv[province_no][]" value="<?=$deliv["province_no"]?>" class="province_no" />
                                <input type="hidden" name="BsDeliv[city_no][]" value="<?=$deliv["city_no"]?>" class="city_no" />
                                <input type="hidden" name="BsDeliv[country_name][]" value="<?=$deliv["country_name"]?>" class="country_name" />
                                <input type="hidden" name="BsDeliv[province_name][]" value="<?=$deliv["province_name"]?>" class="province_name" />
                                <input type="hidden" name="BsDeliv[city_name][]" value="<?=$deliv["city_name"]?>" class="city_name" />
                                <td><?=$k+1?></td>
            ...
            <div class="mb-20">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="pack_num" value="<?=$data['pack'][1]['pdt_qty']?>" readonly style="text-align:center;height: 30px;border:none;"></td>
            ...
            <div class="mb-20">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td class="editable"><input name="BsPack[2][pdt_qty]" type="text" class="easyui-validatebox" data-options="validType:'decimal[8,2]'"  value="<?=$data["pack"][2]["pdt_qty"]?>" maxlength="9"></td>
            ...
            <div class="mb-20">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td class="editable"><input name="BsPack[4][plate_num]"  class="easyui-validatebox" data-options="validType:'int'" maxlength="11" type="text" value="<?=$data["pack"][4]["plate_num"]?>" maxlength="9"></td>
...
<script>
    ...
    $(function(){
        ...
        $("#min_order").change(function(){
            $(".price-box .minqty:first").text($(this).val());
        ...
        $("#add-form").on("beforeSubmit", function () {
            ...
            if($.isNumeric(parseFloat($(".maxqty:first").text()))  && parseFloat($(".maxqty:first").text())<=parseFloat($("#min_order").val())){
                layer.alert("基本信息的最小起订量必须小于销售价格的第一个最大值！",{icon:2});
                    ...
                    if (data.flag == 1) {
                        layer.alert(data.msg, {
                            icon: 1,
                                ...
                                $.ajax({
                                    type:"get",
                                    url:"<?=\yii\helpers\Url::to(['get-bus-type','code'=>'uptepdtsel'])?>",
                                    success:function(data){
                                        var type=data;
                                        $.fancybox({
                                            href: "<?=Url::to(['reviewer'])?>?type=" + type + "&id=" + id + "&url=" + url+"&staff_id=1446",
                                            type: "iframe",
                                            padding: 0,
                                            autoSize: false,
                                            width: 750,
        ...
        $("#_addrow").click(function () {
            var tr=$('<tr>' +
                '<td class="editable" width="200"><input class="easyui-validatebox minqty" data-options="validType:[\'decimal[11,2]\']" name="BsStock[min_qty][]" type="text" maxlength="11" readonly></td>' +
