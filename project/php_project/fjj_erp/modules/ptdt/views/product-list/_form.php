...
<div>
    <div class="mb-10">
        ...
        <span class="value-width value-align"><?=$model["cat_three_level"];?></span>
    </div>
    <div class="mb-10">
        ...
        <?=Html::dropDownList("brand_id",$model["brand_id"],$options["brands"],["prompt"=>"请选择","class"=>"value-width value-align easyui-validatebox","data-options"=>"required:true"])?>
    </div>
    <div class="mb-10">
        <label class="label-width label-align" for="">商品标题：</label>
        <input class="value-width value-align easyui-validatebox" data-options="" type="text" name="pdt_title" value="<?=$model['pdt_title']?>" maxlength="200">

        <label class="label-width label-align" for="">商品关键字：</label>
        <input class="value-width value-align easyui-validatebox" data-options="" type="text" name="pdt_keyword" value="<?=$model['pdt_keyword']?>" maxlength="200">
    </div>
    <div class="mb-10">
        <label class="label-width label-align"><span class="red">*</span>商品标签：</label>
        <input class="value-width value-align easyui-validatebox" data-options="required:'true'" data-options="validType:'telphone'" type="text" name="pdt_label" value="<?=$model['pdt_label']?>" maxlength="100">
...
<div class="ml-10">
    ...
    <div class="mb-10">
        ...
        <input class="upBtn" data-target-type="text" data-server="<?=Url::to(['upload'])?>" data-target="#upload3D" style="outline: none;" type="button" value="选择文件">
...
<div class="mb-10">
    <table class="table">
        ...
        <?php foreach ($model["related_product"] as $product){?>
                <tr>
                    <td><input type='checkbox' disabled="true" name="RPdtPdt[r_pdt_pkid][]" value="<?=$product['pdt_pkid']?>" <?=$product["selected"]=="Y"?"checked":""?> ></td>
...
<div class="text-center">
    ...
    <button class="button-white-big" onclick="window.location.href='<?=Url::to(["partno-list",'id'=>\Yii::$app->request->get('id')])?>'" type="button">查看相关料号</button>
