...
<div class="content">
    ...
    <label class="width-150" for="pdsupplier-supplier_issupplier">是否集团供应商</label>
...
<div class="mt-20">
    <div class="inline-block ml-30 field-pdsupplier-supplier_sname">
        <label class="width-90" for="pdsupplier-supplier_sname">供应商全称</label>
...
<div class="mt-20">
    <div class="inline-block ml-20 field-pdsupplier-outer_cus_object">
        ...
        <textarea id="pdsupplier-outer_cus_object" class="width-800 easyui-validatebox"  data-options="required:true" name="PdSupplier[outer_cus_object]" rows="4"><?= $supplier['outer_cus_object'] ?></textarea>
...
<div class="mt-20">
    <div class="inline-block ml-20 field-pdsupplier-cus_quality_require">
        ...
        <textarea id="pdsupplier-cus_quality_require" class="width-800 easyui-validatebox"  data-options="required:true" name="PdSupplier[cus_quality_require]" rows="4"><?= $supplier['cus_quality_require'] ?></textarea>
...
<div class="mt-20">
    ...
    <div class="mt-20">
        <div class="inline-block ml-20 field-pdsupplier-supplier_business">
            ...
            <textarea id="pdsupplier-supplier_business" class="width-800 easyui-validatebox"  data-options="required:true" name="PdSupplier[supplier_business]" rows="4"><?= $supplier['business']?>
            </textarea>
