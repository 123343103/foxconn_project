    ...
    <div class="mb-30">
        ...
        <?php $form = ActiveForm::begin(['id' => 'add-form','method'=>"POST"]); ?>
            <div class="mb-20">
                ...
                <input name="pdt_manager" class="width-150 " id="pdt_manager" value="">
            ...
            <div class="mb-20">
                ...
                <input name="archrival" class="width-150 " id="center" value="">
                <label class="width-150">市场均价</label>
                <input name="market_price" class="width-150 " id="applydep" value="">
                <label class="width-150 ">适用产业</label>
                <input name="usefor" class="width-150 " id="applydep" value="">
            </div>
            <div class="mb-20">
            ...
            <div class="mb-20">
                ...
                <input name="valid_date" class="width-150 select-date" type="text" id="pdt_name" value="">
                <label class="width-150">品牌</label>
                <input name="brand" class="width-150 " id="iskz" value="">
            ...
            <div class="mb-20">
                ...
                <input name="packagespc" class="width-150 " id="packagespc" value="">
            </div>
            <div class="mb-20">
        ...
        <div class="mb-20">
            ...
            <input name="salearea" type="radio" class="ml-10" value="全国"><span>全国</span>
            <input name="salearea" class="ml-10" type="radio" value="全国(不含港澳台)"><span>全国(不含港澳台)</span>
            <input id="cur-addr-input"  name="salearea" type="radio" value=""><span>省</span>
            <div id="area-selector" class="ml-100" style="display: none;">
                <?=Html::dropDownList("","",[""=>"请选择","1"=>"中国"],["id"=>"disName_1","class"=>" ml-30 width-130 disName"])?>
                <?=Html::dropDownList("","",[""=>"请选择"],["id"=>"disName_2","class"=>" ml-30 width-130 disName"])?>
                <?=Html::dropDownList("","",[""=>"请选择"],["id"=>"disName_3","class"=>" ml-30 width-130 disName"])?>
                <?=Html::dropDownList("","",[""=>"请选择"],["id"=>"disName_4","class"=>" ml-30 width-130 disName"])?>
                <span id="cur-addr-text" class="ml-30" style="vertical-align: middle;"></span>
            </div>
        </div>
            <div class="space-10"
            ></div>
        ...
        <input type="hidden" name="part_no">
            ...
            <div class="mb-20">
                ...
                <input class="width-150" type="text" value="<?=\Yii::$app->user->identity->staff->staff_name?>">
                <label class="width-100" for="">部门</label>
                <input class="width-150" type="text" value="<?=\Yii::$app->user->identity->staff->organization_code?>">
            </div>
        <div class="mb-20">
            <label class="width-100" for="">邮箱</label>
            <input class="width-150" type="text"  value="<?=\Yii::$app->user->identity->staff->staff_email?>">
