...
<div class="select-com">
    <div style="height:30px;">
        ...
        <p class="float-left">
            <input type="text" name="PdFirmReportSearch[firmMessage]" class="width-200" value="<?= $get['PdFirmReportSearch']['firmMessage'] ?>"><img id="img" src="<?= Url::to('@web/img/icon/search.png') ?>" title="搜索">
...
//        alert("<?//=Yii::$app->request->getHostInfo() . Yii::$app->request->url?>//");
        ...
        $("#check").click(function(){
            ...
            console.log($("#data").datagrid("getSelected"));
//            $.ajax({
//                type:"get",
//                dataType:"json",
//                data:{"id":id},
...
//                    console.log(data);
//                    $("#firm_id",window.parent.document).val(Number(data['firm'].firm_id));
