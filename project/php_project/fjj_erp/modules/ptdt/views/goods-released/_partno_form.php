...
<div class="content">
    <div class="_basic">
        <input type="hidden" name="BsPartno[part_no]" value="<?=\Yii::$app->request->get('partno')?>">
        ...
        <div id="content">
            <div id="tab_bar">
                <ul>
                    ...
                    <?php if(\Yii::$app->request->get('isDevice')){ ?><li class="tab_li" id="tab9" onclick="myclick(9)">设备用途</li><?php } ?>
                </ul>
            </div>
        </div>
        <div class="tab_css" id="tab1_content" style="display: block">
            ...
            <div class="text-center">
                ...
                <button style="margin-left:40px;" class="button-blue-big sub" type="submit">提交</button>
            ...
            <table class="table">
                ...
                <tr>
                    <td class="editable" width="200">
                        <?php if($k==0){?>
                            <input class="minqty easyui-validatebox" data-options="validType:['decimal[19,2]','minqty']" name="BsPrice[minqty][]" type="text" value="<?=$price['minqty']?>" maxlength="19" readonly>
                        <?php }else{ ?>
                            <input class="minqty"  name="BsPrice[minqty][]" type="text" value="<?=$price['minqty']?>" maxlength="11">
                        <?php } ?>
                    </td>
                    <td class="editable" width="200">
                        <?php if($k+1==count($data["price"])){ ?>
                            <input class="maxqty easyui-validatebox" data-options="validType:['decimal[19,2]','maxqty']" name="BsPrice[maxqty][]" type="text" value="<?=$price['maxqty']?>" maxlength="19" readonly>
                        <?php }else{ ?>
                            <input class="maxqty easyui-validatebox" data-options="validType:['decimal[19,2]','maxqty']" name="BsPrice[maxqty][]" type="text" value="<?=$price['maxqty']?>" maxlength="19">
                        <?php } ?>
                    </td>
                    <td class="editable" width="200">
                ...
                <?php }else{ ?>
                    <tr>
                        <td class="editable" width="200">
                            <input class="minqty easyui-validatebox" data-options="validType:['decimal[19,2]','minqty']" name="BsPrice[minqty][]" type="text" value="<?=$data['partno']['min_order']?>" maxlength="19" readonly>
                        </td>
                        <td class="editable" width="200">
                            <input class="maxqty easyui-validatebox" data-options="validType:['decimal[19,2]','maxqty']" name="BsPrice[maxqty][]" type="text" value="<?=$price['maxqty']?>" maxlength="19" readonly>
                        </td>
            ...
            <table class="table">
                ...
                <?php if(count($data["stock"])>0){ ?>
                    <?php foreach($data["stock"] as $k=>$stock){ ?>
                        <tr>
                            <?php if($k==0){ ?>
                                <td class="editable" width="200"><input type="text" class="easyui-validatebox minqty" data-options="required:true,validType:['decimal[11,2]','minqty']" name="BsStock[min_qty][]" value="<?=$stock["min_qty"]?>" maxlength="11"></td>
                            <?php }else{ ?>
                                <td class="editable" width="200"><input type="text" class="easyui-validatebox minqty" data-options="required:true,validType:'decimal[11,2]'" name="BsStock[min_qty][]" value="<?=$stock["min_qty"]?>" maxlength="11"></td>
                            <?php } ?>
        ...
        <?php if(\Yii::$app->request->get('isDevice')){ ?>
...
<script>
    ...
    $(function(){
        ...
        $("#_addrow").click(function () {
            var tr=$('<tr>' +
                '<td class="editable" width="200"><input class="easyui-validatebox minqty" data-options="required:true,validType:\'decimal[11,2]\'" name="BsStock[min_qty][]" type="text" maxlength="11" readonly></td>' +
