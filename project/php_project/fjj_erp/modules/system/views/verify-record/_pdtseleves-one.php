        ...
        <div class="content">
            ...
            <div style="height: 510px;">
                ...
                <div style="height: 385px;">
                    ...
                    <?php if ($isUpOrDown == 1) { ?>
                        <h2 class="head-second text-left">商品下架原因</h2>
                        <div style="margin-top: -10px;">
                            <table width="100%" class="no-border vertical-center ml-25"
                                   style="border-collapse:separate; border-spacing:0px 18px;">
                                <tr class="no-border">
                                    <td class="no-border vertical-center"
                                        style="text-align:right;width: 12%;padding-right: 4px;">下架原因：
                                    </td>
                                ...
                                <tr class="no-border">
                                    <td class="no-border vertical-center"
                                        style="text-align: right;width:12%;padding-right: 4px;">附&nbsp&nbsp件：
                                    </td>
                    ...
                    <div style="55margin-top: -10px;width: 100%;height: 265px;">
                        ...
                        <div style="float:left;width:30%;height:245px;padding-top:18px">
            <span style="width: 100%">
                ...
                <div style="height: 25px;">
                    <div style="float: left;margin-left: 15px;"><label style="margin-left: 3px;">详细说明 ：</label></div>
                    <div style="float: left;"><img src="../../img/layout/u1456.png" id="pdt_details"/></div>
                </div>

                <div class="space-10"></div>
                <div style="width:93%;height:auto;margin-left: 53px;display: none;margin-top: 10px;" id="img_div"
                     class="detail">
    ...
    <div class="content">
        ...
        <div class="table-content">
            ...
            <div id="data" style="width: 100%;">
                ...
                <div class="pn-partnotab-1 partnotab" style="width: 100%;">
                    <table class="no-border vertical-center ml-25"
                           style="border-collapse:separate; border-spacing:0px 15px;width: 100%;">
                        <tr class="no-border">
                            <td class="no-border vertical-center " width="16%" style="text-align: right;">原产地：</td>
                            <td class="no-border vertical-center " width="15%"><?= $model4["pdt_origin"] ?></td>
                            <td class="no-border vertical-center " width="19%" style="text-align: right;">型号：</td>
                            <td class="no-border vertical-center " width=17%" style="word-break: break-all"><?= $model4["tp_spec"] ?></td>
                            <td class="no-border vertical-center " width="14%" style="text-align: right;">保质期(月)：</td>
                            <td class="no-border vertical-center " width="18%"><?= $model4["warranty_period"] ?></td>
                            <td class="no-border vertical-center" width="2%"></td>
                        </tr>
                        <tr class="no-border">
                            <td class="no-border vertical-center " width="19%" style="text-align: right;">销售包装数量：
                            </td>
                            <td class="no-border vertical-center " width="17%"><?= $model4["pdt_qty"] ?></td>
                            <td class="no-border vertical-center " width="16%" style="text-align: right;">最小起订量：</td>
                            <td class="no-border vertical-center " width="15%"><?= $model4["min_order"] ?></td>
                            <td class="no-border vertical-center " width="14%" style="text-align: right;">供应商：</td>
                            <td class="no-border vertical-center " width="18%"><?= $model4["spp_sname"] ?></td>
                            <td class="no-border vertical-center" width="2%"></td>
                        </tr>
                        <tr class="no-border">
                            <td class="no-border vertical-center " width="19%" style="text-align: right;">商品定位：
                            </td>
                            <td class="no-border vertical-center "
                                width="17%"><?php if ($model4["cm_pos"] == 1) echo "高"; else if ($model4["cm_pos"] == 2) echo "中"; else echo "低"; ?></td>
                            <td class="no-border vertical-center " width="16%" style="text-align: right;">L/T(天)：</td>
                            <td class="no-border vertical-center " width="15%"><?= $model4["l/t"] ?></td>
                            <td class="no-border vertical-center " width="14%" style="text-align: right;">法务风险等级：</td>
                            <td class="no-border vertical-center "
                                width="18%"><?php if ($model4["leg_lv"] == 0) echo "高"; else if ($model4["leg_lv"] == 1) echo "中"; else if ($model4["leg_lv"] == 2) echo "低"; else if ($model4["leg_lv"] == -1) echo "/"; ?></td>
                            <td class="no-border vertical-center" width="2%"></td>
                        </tr>
                        <tr class="no-border">
                            <td class="no-border vertical-center " width="16%" style="text-align: right;">是否可议价：</td>
                            <td class="no-border vertical-center "
                                width="15%"><?= $model4["yn_inquiry"] == 1 ? '是' : '否' ?></td>
                            <td class="no-border vertical-center " width="19%" style="text-align: right;">是否保税：</td>
                            <td class="no-border vertical-center "
                                width="17%"><?= $model4["yn_tax"] == 1 ? '是' : '否' ?></td>
                            <td class="no-border vertical-center " width="14%" style="text-align: right;">是否自提：</td>
                            <td class="no-border vertical-center "
                                width="18%"><?= $model4["isselftake"] == 1 ? '是' : '否' ?></td>
                            <td class="no-border vertical-center" width="2%"></td>
                            <input type="hidden" value="<?= $model4["isselftake"] ?>" id="isselftake"/>
                        </tr>
                        <tr class="no-border">
                            <td class="no-border vertical-center " width="16%" style="text-align: right;">是否代理：</td>
                            <td class="no-border vertical-center "
                                width="15%"><?= $model4["is_agent"] == 1 ? "是" : "否" ?></td>
                            <td class="no-border vertical-center " width="19%" style="text-align: right;">是否批次管理：</td>
                            <td class="no-border vertical-center "
                                width="17%"><?php if ($model4["is_batch"] == 1) echo "是"; else echo "否"; ?></td>
                            <td class="no-border vertical-center " width="14%" style="text-align: right;">是否拳头商品：</td>
                            <td class="no-border vertical-center "
                                width="18%"><?= $model4["is_first"] == 1 ? '是' : '否' ?></td>
                            <td class="no-border vertical-center" width="2%"></td>
                        </tr>
                        <tr>
                            <td class="no-border vertical-center" width="16%" style="text-align: right;">
                                备&nbsp&nbsp&nbsp注：
                            </td>
                            <td colspan="4" class="no-border vertical-center" style="word-break: break-all;"><?= $model4["marks"] ?></td>
                        </tr>
                    </table>
                    <div style="width: 100%;" id="prtwm">
                        <p id="wm" style="display: none;"><label>自提仓库 :</label></p>
                        <div id="data-area" style="width: 100%;"></div>
                    </div>
                </div>
            </div>
                ...
                <table class="no-border vertical-center"
                    ...
                    <?php foreach ($data as $value) { ?>
                        <tr class="no-border mb-10">
                            <td class="label-align no-border" style="white-space:nowrap;font-size: 12px;font-family: "
                                Microsoft
                                YaHei
                            ""><?= Html::decode($value['attr_name']) ?>：</td>
                            <td style="width: 71%;padding-left: 10px;word-break:break-all;" class="no-border"><?= $value['attr_value'] ?></td>
                        </tr>
                    <?php } ?>
            ...
            <div class="pn-partnotab-7 partnotab" style="display: none;">
                ...
                <div style="margin-top: 10px;">
                    ...
                    <table class="table" style="width: 100%;margin-top: 5px">
                        ...
                        <th width="100px">净重</th>
                        <th width="100px">包装名称</th>
                        <th width="100px">销售包装数量</th>
                        </thead>
                        <tbody>
                        <tr>
