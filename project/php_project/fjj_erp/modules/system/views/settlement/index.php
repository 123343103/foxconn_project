...
$this->params['breadcrumbs'][] = ['label' => '结算方式列表'];
//$this->params['breadcrumbs'][] = $this->title;

$search = Yii::$app->request->get();
if (!isset($search['SettlementSearch'])) {
    $search['SettlementSearch'] = null;
}
?>
<style>
    .width-60{
...
<div class="content">
    ...
    <div class="inline-block ">
        ...
        <input type="text"  class="width-150" name="SettlementSearch[bnt_code]" value="<?= $search['SettlementSearch']['bnt_code']?>">
    </div>
    <div class="inline-block ml-30">
        <label class="width-60" >结算方式<label>：</label></label>
        <input type="text"  class="width-150" name="SettlementSearch[bnt_sname]" value="<?= $search['SettlementSearch']['bnt_sname']?>">
    </div>
    <div class="inline-block">
    ...
    <div class="table-head" style="margin-top: 20px">
        ...
        <div class="float-right">
            <a href="<?= Url::to(['/system/settlement/create']) ?>">
                <div class='table-nav'>
            ...
            <?= Menu::isAction('/system/settlement/update') ?
                "<a id='edit' >
                    <div class='table-nav'>
                ...
                : '' ?>
            <span  style='float: left;'>&nbsp;|&nbsp;</span>
            <?= Menu::isAction('/system/settlement/delete') ?
                "<a id='delete' >
                    <div class='table-nav'>
    ...
    $(function () {
        $("#data").datagrid({
            ...
            columns: [[
                ...
                {field: "bnt_code", title: "代码",width:"240"},

                {field: "bnt_sname", title: "结算方式",width:"240"},
        ...
        $("#edit").on("click", function () {
            ...
            if (a == null) {
                ...
                var id =$("#data").datagrid("getSelected")['bnt_id'];
                ...
                layer.confirm("确定要删除这条信息吗?",
                    ...
                    function () {
                        $.ajax({
                            ...
                            dataType: "json",
                            data: {"id": id},
                            url: "<?=Url::to(['/system/settlement/delete']) ?>",
