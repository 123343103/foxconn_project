...
$this->params['breadcrumbs'][] = ['label' => '交易相关设置', 'url' => \yii\helpers\Url::to(['/system/transaction/index'])];
$this->params['breadcrumbs'][] = ['label' => '货币类别列表'];
//$this->params['breadcrumbs'][] = $this->title;

$search = Yii::$app->request->get();
if (!isset($search['CurrencySearch'])) {
    $search['CurrencySearch'] = null;
}
?>
<style>
    .width-60{
...
<div class="content">
    ...
    <div class="inline-block ">
        ...
        <input type="text"  class="width-150" name="CurrencySearch[cur_code]" value="<?= $search['CurrencySearch']['cur_code']?>">
    </div>
    <div class="inline-block ml-30">
        <label class="width-60" >货币类别<label>：</label></label>
        <input type="text"  class="width-150" name="CurrencySearch[cur_sname]" value="<?= $search['CurrencySearch']['cur_sname']?>">
    </div>
    <div class="inline-block">
    ...
    <div class="table-head" style="margin-top: 20px">
        ...
        <div class="float-right">
            <a href="<?= Url::to(['/system/currency/create']) ?>">
                <div class='table-nav'>
            ...
            <?= Menu::isAction('/system/currency/update') ?
                "<a id='edit' >
                    <div class='table-nav'>
                ...
                : '' ?>
            <span  style='float: left;'>&nbsp;|&nbsp;</span>
            <?= Menu::isAction('/system/currency/delete') ?
                "<a id='delete' >
                    <div class='table-nav'>
    ...
    $(function () {
        $("#data").datagrid({
            ...
            columns: [[
                ...
                {field: "cur_code", title: "代码",width:"240"},

                {field: "cur_sname", title: "货币名称",width:"240"},
        ...
        $("#edit").on("click", function () {
            ...
            if (a == null) {
                ...
                var id =$("#data").datagrid("getSelected")['cur_id'];
                ...
                layer.confirm("确定要删除这条信息吗?",
                    ...
                    function () {
                        $.ajax({
                            ...
                            dataType: "json",
                            data: {"id": id},
                            url: "<?=Url::to(['/system/currency/delete']) ?>",
