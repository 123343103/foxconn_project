...
$this->params['breadcrumbs'][] = ['label' => '交易相关设置'];
$this->params['breadcrumbs'][] = ['label' => '货币类别列表'];
$this->params['breadcrumbs'][] = ['label' => '货币类别详情'];
?>
<div class="content">
    <!--<p>
    ...
    <div class="mb-30">
        <div class="mb-10">
            ...
            <span class="width-300"><?= $model->dec_code ?></span>
            <label class="width-100 ">交货名称</label>
            <span class="width-300"><?= $model->dec_sname?></span>
        </div>
