...
$this->params['breadcrumbs'][] = ['label' => '交货方式列表'];
//$this->params['breadcrumbs'][] = $this->title;

$search = Yii::$app->request->get();
if (!isset($search['DevconSearch'])) {
    $search['DevconSearch'] = null;
}
?>
<style>
    .width-60{
...
<div class="content">
    ...
    <div class="inline-block ">
        ...
        <input type="text"  class="width-150" name="DevconSearch[dec_code]" value="<?= $search['DevconSearch']['dec_code']?>">
    </div>
    <div class="inline-block ml-30">
        <label class="width-60" >交货方式<label>：</label></label>
        <input type="text"  class="width-150" name="DevconSearch[dec_sname]" value="<?= $search['DevconSearch']['dec_sname']?>">
    </div>
    <div class="inline-block">
    ...
    <div class="table-head" style="margin-top: 20px">
        ...
        <div class="float-right">
            <a href="<?= Url::to(['/system/devcon/create']) ?>">
                <div class='table-nav'>
            ...
            <?= Menu::isAction('/system/devcon/update') ?
                "<a id='edit' >
                    <div class='table-nav'>
                ...
                : '' ?>
            <span  style='float: left;'>&nbsp;|&nbsp;</span>
            <?= Menu::isAction('/system/devcon/delete') ?
                "<a id='delete' >
                    <div class='table-nav'>
    ...
    $(function () {
        $("#data").datagrid({
            ...
            columns: [[
                ...
                {field: "dec_code", title: "代码",width:"240"},

                {field: "dec_sname", title: "交货方式",width:"240"},
        ...
        $("#edit").on("click", function () {
            ...
            if (a == null) {
                ...
                var id =$("#data").datagrid("getSelected")['dec_id'];
                ...
                layer.confirm("确定要删除这条信息吗?",
                    ...
                    function () {
                        $.ajax({
                            ...
                            dataType: "json",
                            data: {"id": id},
                            url: "<?=Url::to(['/system/devcon/delete']) ?>",
