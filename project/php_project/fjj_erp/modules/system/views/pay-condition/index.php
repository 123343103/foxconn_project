...
if (!isset($search['PayConditionSearch'])) {
    $search['PayConditionSearch'] = null;
}
?>
<style>
    .width-60{
...
<div class="content">
    ...
    <div class="inline-block ">
        ...
        <input type="text"  class="width-150" name="PayConditionSearch[pat_code]" value="<?= $search['PayConditionSearch']['pat_code']?>">
    </div>
    <div class="inline-block ml-30">
        <label class="width-60" >付款条件<label>：</label></label>
        <input type="text"  class="width-150" name="PayConditionSearch[pat_sname]" value="<?= $search['PayConditionSearch']['pat_sname']?>">
    </div>
    <div class="inline-block">
    ...
    <div class="table-head" style="margin-top: 20px">
        ...
        <div class="float-right">
            <a href="<?= Url::to(['/system/pay-condition/create']) ?>">
                <div class='table-nav'>
            ...
            <?= Menu::isAction('/system/pay-condition/update') ?
                "<a id='edit' >
                    <div class='table-nav'>
                ...
                : '' ?>
            <span  style='float: left;'>&nbsp;|&nbsp;</span>
            <?= Menu::isAction('/system/pay-condition/delete') ?
                "<a id='delete' >
                    <div class='table-nav'>
    ...
    $(function () {
        $("#data").datagrid({
            ...
            columns: [[
                ...
                {field: "pat_code", title: "代码",width:"240"},

                {field: "pat_sname", title: "付款条件",width:"240"},
        ...
        $("#edit").on("click", function () {
            ...
            if (a == null) {
                ...
                var id =$("#data").datagrid("getSelected")['pat_id'];
                ...
                layer.confirm("确定要删除这条信息吗?",
                    ...
                    function () {
                        $.ajax({
                            ...
                            dataType: "json",
                            data: {"id": id},
                            url: "<?=Url::to(['/system/pay-condition/delete']) ?>",
