...
$this->params['breadcrumbs'][] = ['label' => '交易条件列表', 'url' => Url::to(['/system/transaction/transaction-index'])];
$this->params['breadcrumbs'][] = ['label' => '交易条件详情'];
?>
<div class="content">
    <!--<p>
    ...
    <div class="mb-30">
        <div class="mb-10">
            ...
            <span class="width-300"><?= $model->tcc_code ?></span>
            <label class="width-100 ">交易条件</label>
            <span class="width-300"><?= $model->tcc_sname?></span>
        </div>
