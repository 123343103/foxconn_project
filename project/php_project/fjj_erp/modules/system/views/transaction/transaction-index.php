...
$this->params['breadcrumbs'][] = ['label' => '交易方式列表'];
$search = Yii::$app->request->get();
if (!isset($search['TransactionSearch'])) {
...
<div class="content">
    <?php $form = ActiveForm::begin (['method' => "get","action"=>"transaction-index"]); ?>
    <div class="inline-block ">
        <label class="width-60" >代码</label><label>：</label>
        <input type="text"  class="width-150" name="TransactionSearch[tac_code]" value="<?= $search['TransactionSearch']['tac_code']?>">
    </div>
    <div class="inline-block ml-30">
        <label class="width-60" >交易方式</label><label>：</label>
        <input type="text"  class="width-150" name="TransactionSearch[tac_sname]" value="<?= $search['TransactionSearch']['tac_sname']?>">
    </div>
    <div class="inline-block">
    ...
    <div class="table-head mt-20">
        ...
        <div class="float-right">
            <a href="<?= Url::to(['/system/transaction/create']) ?>">
                <div class='table-nav'>
            ...
            <?= Menu::isAction('/system/transaction/update') ?
                "<a id='edit' >
                    <div class='table-nav'>
                ...
                : '' ?>
            <span  style='float: left;'>&nbsp;|&nbsp;</span>
            <?= Menu::isAction('/system/transaction/delete') ?
                "<a id='delete' >
                    <div class='table-nav'>
    ...
    $(function () {
        $("#data").datagrid({
            ...
            columns: [[
                ...
                {field: "tac_code", title: "代码",width:"240"},

                {field: "tac_sname", title: "交易方式",width:"240"},
        ...
        $("#edit").on("click", function () {
            ...
            if (a == null) {
                ...
                var id =$("#data").datagrid("getSelected")['tac_id'];
                ...
                layer.confirm("确定要删除这条信息吗?",
                    ...
                    function () {
                        $.ajax({
                            ...
                            dataType: "json",
                            data: {"id": id},
                            url: "<?=Url::to(['/system/transaction/delete']) ?>",
