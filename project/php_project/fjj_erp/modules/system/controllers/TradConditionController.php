 ...
 */
class TradConditionController extends BaseController
{
    private $_url = 'system/trad-condition/';
    ...
    public function actionCreate()
    {
        if (Yii::$app->request->getIsPost()){
            ...
            $postData['BsTradConditions']['create_by'] = Yii::$app->user->identity->staff_id;
            $postData['BsTradConditions']['create_at'] = date("Y-m-d", time());
    ...
    public function actionUpdate($id)
    {
        if (Yii::$app->request->getIsPost()){
            $postData = Yii::$app->request->post();
            $postData['BsTradConditions']['update_by'] = Yii::$app->user->identity->staff_id;
            $postData['BsTradConditions']['update_at'] = date("Y-m-d", time());
