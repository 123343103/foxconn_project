...
/**
 * CurrencyController implements the CRUD actions for BsCurrency model.
 */
class CurrencyController extends BaseController
{
    private $_url = 'system/currency/';
    /**
    ...
    public function actionCreate()
    {
        if (Yii::$app->request->getIsPost()){
            ...
            $postData['BsCurrency']['create_by'] = Yii::$app->user->identity->staff_id;
            $postData['BsCurrency']['create_at'] = date("Y-m-d", time());
    ...
    public function actionUpdate($id)
    {
        if (Yii::$app->request->getIsPost()){
            $postData = Yii::$app->request->post();
            $postData['BsCurrency']['update_by'] = Yii::$app->user->identity->staff_id;
            $postData['BsCurrency']['update_at'] = date("Y-m-d", time());
