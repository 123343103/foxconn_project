...
/**
 * PayConditionController implements the CRUD actions for BsPayCondition model.
 */
class PayConditionController extends BaseController
{

    private $_url = 'system/pay-condition/';
    /**
    ...
    public function actionCreate()
    {
        if (Yii::$app->request->getIsPost()){
            ...
            $postData['BsPayCondition']['create_by'] = Yii::$app->user->identity->staff_id;
            $postData['BsPayCondition']['create_at'] = date("Y-m-d", time());
    ...
    public function actionUpdate($id)
    {
        if (Yii::$app->request->getIsPost()){
            $postData = Yii::$app->request->post();
            $postData['BsPayCondition']['update_by'] = Yii::$app->user->identity->staff_id;
            $postData['BsPayCondition']['update_at'] = date("Y-m-d", time());
