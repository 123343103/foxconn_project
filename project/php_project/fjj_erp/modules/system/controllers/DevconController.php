...
/**
 * DevconController implements the CRUD actions for BsDevcon model.
 */
class DevconController extends BaseController
{

    private $_url = 'system/devcon/';
    /**
    ...
    public function actionCreate()
    {
        if (Yii::$app->request->getIsPost()){
            ...
            $postData['BsDevcon']['create_by'] = Yii::$app->user->identity->staff_id;
            $postData['BsDevcon']['create_at'] = date("Y-m-d", time());
    ...
    public function actionUpdate($id)
    {
        if (Yii::$app->request->getIsPost()){
            $postData = Yii::$app->request->post();
            $postData['BsDevcon']['update_by'] = Yii::$app->user->identity->staff_id;
            $postData['BsDevcon']['update_at'] = date("Y-m-d", time());
