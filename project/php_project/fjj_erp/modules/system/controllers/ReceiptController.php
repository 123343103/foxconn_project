...
use app\modules\common\models\BsReceipt;
...
/**
 * ReceiptController implements the CRUD actions for BsReceipt model.
 */
class ReceiptController extends BaseController
{

    private $_url = 'system/receipt/';
    /**
    ...
    public function actionCreate()
    {
        if (Yii::$app->request->getIsPost()){
            ...
            $postData['BsReceipt']['create_by'] = Yii::$app->user->identity->staff_id;
            $postData['BsReceipt']['create_at'] = date("Y-m-d", time());
    ...
    public function actionUpdate($id)
    {
        if (Yii::$app->request->getIsPost()){
            $postData = Yii::$app->request->post();
            $postData['BsReceipt']['update_by'] = Yii::$app->user->identity->staff_id;
            $postData['BsReceipt']['update_at'] = date("Y-m-d", time());
