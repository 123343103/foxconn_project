...
/**
 * PaymentController implements the CRUD actions for BsPayment model.
 */
class PaymentController extends BaseController
{
    private $_url = 'system/payment/';
    /**
    ...
    public function actionCreate()
    {
        if (Yii::$app->request->getIsPost()){
            ...
            $postData['BsPayment']['create_by'] = Yii::$app->user->identity->staff_id;
            $postData['BsPayment']['create_at'] = date("Y-m-d", time());
    ...
    public function actionUpdate($id)
    {
        if (Yii::$app->request->getIsPost()){
            $postData = Yii::$app->request->post();
            $postData['BsPayment']['update_by'] = Yii::$app->user->identity->staff_id;
            $postData['BsPayment']['update_at'] = date("Y-m-d", time());
